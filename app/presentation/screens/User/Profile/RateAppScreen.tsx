          ...
          { text: "Để sau", style: "cancel" },
          {
            ...
            onPress: () => {
              const storeUrl = Platform.select({
                ...
                android:
                  "https://play.google.com/store/apps/details?id=com.expensetracker",
              });
              if (storeUrl) {
    ...
    >
      ...
      >
        ...
        >
          ...
          <View style={styles.statsRow}>
            <View style={styles.statItem}>
              <View
                style={[styles.statIconBox, { backgroundColor: "#FEF7E0" }]}
              >
            ...
            <View style={styles.statItem}>
              <View
                style={[styles.statIconBox, { backgroundColor: "#EFF6FF" }]}
              >
        ...
        >
          ...
          <Text
            style={[styles.thankYouSubtext, { color: theme.textSecondary }]}
          >
