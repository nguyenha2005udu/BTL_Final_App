      ...
      >
        ...
        >
          ...
          <Text style={[styles.paragraph, { color: theme.textSecondary }]}>
            Ứng dụng Expense Tracker cam kết bảo vệ thông tin cá nhân của bạn.
            ...
            <View style={styles.bulletList}>
              <View style={styles.bulletItem}>
                <View
                  style={[
                    styles.bullet,
                    { backgroundColor: isDarkMode ? "#22C55E" : "#DCFCE7" },
                  ]}
                >
          ...
          <View style={styles.section}>
            ...
            <Text style={[styles.paragraph, { color: theme.textSecondary }]}>
              Dữ liệu của bạn được mã hóa và lưu trữ an toàn trên Firebase.
          ...
          <View style={styles.section}>
            ...
            <Text style={[styles.paragraph, { color: theme.textSecondary }]}>
              ...
              thứ ba, trừ khi được yêu cầu bởi pháp luật.
            </Text>
          </View>
          ...
          <View style={styles.section}>
            ...
            <Text style={[styles.paragraph, { color: theme.textSecondary }]}>
              ...
              bất cứ lúc nào thông qua ứng dụng.
            </Text>
          </View>
        ...
        >
          <View style={styles.cardHeader}>
            <View
              style={[
                styles.cardIconBox,
                { backgroundColor: isDarkMode ? "#1E3D2E" : "#DCFCE7" },
              ]}
            >
          ...
          <Text style={[styles.paragraph, { color: theme.textSecondary }]}>
            Bằng cách sử dụng ứng dụng này, bạn đồng ý với các điều khoản và
            điều kiện sau:
          </Text>
          ...
          <View style={styles.bulletList}>
            <View style={styles.bulletItem}>
              <View
                style={[
                  styles.bullet,
                  { backgroundColor: isDarkMode ? "#F59E0B" : "#FEF7E0" },
                ]}
              >
