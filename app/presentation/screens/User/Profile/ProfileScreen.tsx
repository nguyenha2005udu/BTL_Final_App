    ...
    >
      ...
      >
            ...
            <View style={styles.rowItem}>
              <View style={styles.rowLeft}>
                <View
                  style={[
                    styles.iconBox,
                    { backgroundColor: isDarkMode ? "#4A3D1D" : "#FEF7E0" },
                  ]}
                >
            ...
            >
              <View style={styles.rowLeft}>
                <View
                  style={[
                    styles.iconBox,
                    { backgroundColor: isDarkMode ? "#4A1D1D" : "#FEE2E2" },
                  ]}
                >
            ...
            >
              <View style={styles.rowLeft}>
                <View
                  style={[
                    styles.iconBox,
                    { backgroundColor: isDarkMode ? "#0D3D3D" : "#CFFAFE" },
                  ]}
                >
        ...
        <TouchableOpacity
          style={[
            styles.logoutButton,
            { backgroundColor: isDarkMode ? "#4A1D1D" : "#FFFFFF" },
          ]}
