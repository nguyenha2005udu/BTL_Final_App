  ...
  const faqs = [
    {
      ...
      answer:
        'Nhấn vào nút "+" ở góc dưới bên phải màn hình chính, chọn loại giao dịch (Thu/Chi), nhập số tiền, chọn danh mục và thêm ghi chú nếu cần.',
    ...
    },
    {
      ...
      answer:
        'Vào tab "Báo cáo" ở thanh menu dưới cùng. Bạn có thể xem chi tiêu theo tuần, tháng hoặc tùy chọn thời gian.',
      icon: "assessment",
      color: "#8B5CF6",
    },
    {
      ...
      answer:
        'Có! Vào màn hình Mục tiêu, nhấn "Tạo mục tiêu mới", nhập tên, số tiền mục tiêu và thời hạn. Bạn có thể theo dõi tiến độ và nạp/rút tiền bất cứ lúc nào.',
      icon: "savings",
      color: "#22C55E",
    },
    {
      ...
      answer:
        "Vào Profile → Đổi mật khẩu. Nhập mật khẩu hiện tại và mật khẩu mới, sau đó xác nhận.",
      icon: "lock-outline",
      color: "#F59E0B",
    },
    {
      ...
      answer:
        "Có, tất cả dữ liệu được tự động đồng bộ và sao lưu trên cloud. Bạn có thể đăng nhập trên nhiều thiết bị để truy cập dữ liệu.",
      icon: "cloud-done",
      color: "#06B6D4",
    },
    {
      ...
      answer:
        'Có! Vào màn hình Báo cáo, chọn "Xuất CSV" hoặc "Xuất PDF" để tải dữ liệu về máy.',
      icon: "file-download",
      color: "#EC4899",
    },
    {
      ...
      answer:
        "Liên hệ với chúng tôi qua email support@expensetracker.com để yêu cầu xóa tài khoản. Lưu ý: dữ liệu sẽ bị xóa vĩnh viễn.",
      icon: "delete-outline",
      color: "#EF4444",
    },
  ];
            ...
            >
              ...
              >
                <MaterialIcons
                  ...
                  size={20}
                  color={
                    expandedIndex === index ? "#3B82F6" : theme.textSecondary
                  }
                />
              </View>
            </TouchableOpacity>
