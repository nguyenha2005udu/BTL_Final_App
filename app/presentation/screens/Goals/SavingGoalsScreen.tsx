    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <TouchableOpacity style={styles.iconButton}>
          <MaterialIcons name="bar-chart" size={24} color="#111418" />
        </TouchableOpacity>
      </View>
            ...
            >
              <View style={styles.cardHeader}>
                ...
                <View style={styles.statusRow}>
                  <View style={[styles.statusBadge, {
                    backgroundColor: goal.status === 'ongoing' ? '#EFF6FF' : goal.status === 'completed' ? '#F0FDF4' : '#F1F5F9'
                  }]}>
                    <Text style={[styles.statusText, {
                      color: goal.status === 'ongoing' ? '#3c83f6' : goal.status === 'completed' ? '#16A34A' : '#64748B'
                    }]}>
              ...
              <View style={styles.progressSection}>
                <View style={styles.progressInfo}>
                  ...
                  <Text style={styles.progressPercent}>{progress}% đã tiết kiệm</Text>
                </View>
                ...
                <View style={styles.amountRow}>
                  <Text style={styles.amountText}>Đã tiết kiệm: {goal.savedAmount.toLocaleString()}₫</Text>
                  <Text style={styles.amountText}>Mục tiêu: {goal.targetAmount.toLocaleString()}₫</Text>
                </View>
              </View>
              
              <View style={styles.footer}>
                <MaterialIcons name="calendar-today" size={16} color="#64748B" />
                <Text style={styles.footerText}>{goal.deadline ? `Hạn chót: ${goal.deadline}` : 'Không có thời hạn'}</Text>
              </View>
            </TouchableOpacity>
           );
        })}
